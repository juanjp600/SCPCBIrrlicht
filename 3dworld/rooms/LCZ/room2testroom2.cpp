...
void room2testroom2::setBase(irr::scene::IMeshSceneNode* inNode,RMesh* inRme) {
	if (room2testroom2::baseNode==nullptr || room2testroom2::baseRMesh==nullptr) {
		room2testroom2::baseNode = inNode; room2testroom2::baseRMesh = inRme; room2testroom2::baseNode->setVisible(false);
	}
}
