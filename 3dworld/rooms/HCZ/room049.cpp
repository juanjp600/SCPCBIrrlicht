...
void room049::setBase(irr::scene::IMeshSceneNode* inNode,RMesh* inRme) {
	if (room049::baseNode==nullptr || room049::baseRMesh==nullptr) {
		room049::baseNode = inNode; room049::baseRMesh = inRme; room049::baseNode->setVisible(false);
	}
}
