...
void room2offices2::setBase(irr::scene::IMeshSceneNode* inNode,RMesh* inRme) {
	if (room2offices2::baseNode==nullptr || room2offices2::baseRMesh==nullptr) {
		room2offices2::baseNode = inNode; room2offices2::baseRMesh = inRme; room2offices2::baseNode->setVisible(false);
	}
}
